...
File Format Specification: 规定文件中，各个字符的排列顺序，需要存在的 key-value，各个 k-v 的排列组合方式
    ...
    PKCS: Public-Key Cryptography Standards: 公钥密码学标准
        ...
        PKCS#8：描述私有密钥信息格式，该信息包括公开密钥算法的私有密钥以及可选的属性集等。常见文件后缀: .pvt.key.pem .p8
        PKCS#9：定义一些用于PKCS#6证书扩展、PKCS#7数字签名和PKCS#8私钥加密信息的属性类型。
        PKCS#10：描述证书请求语法。常见文件后缀: .csr .p10
        PKCS#11：称为Cyptoki，定义了一套独立于技术的程序设计接口，用于智能卡和PCMCIA卡之类的加密设备。
        PKCS#12：描述个人信息交换语法标准。描述了将用户公钥、私钥、证书和其他相关信息打包的语法。常见文件后缀: .pfx .p12 .pkcs12
        PKCS#13：椭圆曲线密码体制标准。
        PKCS#14：伪随机数生成标准。
        PKCS#15：密码令牌信息格式标准。
